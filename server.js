...
var classRoles = ["Incoming Freshman", "Freshman","Sophomore","Junior","Senior","Grad Student","Alumnus",".","Advanced Computer Graphics","Algorithmic Robotics","Beginning Programming for Engineers","Cognitive Modeling I","Comp Org","Computational Biology","Computational Optimization","Computer Science 1","Data Analytics","Data and Society","Database Systems","Design and Analysis of Algorithms","Distributed Computing Over The Internet","DS","Economics and Computation","FOCS","Game Development II","Integer and Combinatorial Optimization","Intro Algo","Introduction to Data Mathematics","Intro to AI","Intro to Computer Programming","Intro to Network Science", "Large-Scale Matrix Comp & ML","MBE", "NLP","NumComp","OpSys","OSS","Parallel Programming","Principles of Program Analysis","PSoft","Readings in Computer Science","Readings in CSCI","Selmer","SD&D","Software Verification","Times Series Analysis","Web Science Systems Dev","Xinformatics"]//must match name exactly
